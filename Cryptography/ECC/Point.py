...
point1 = ECPoint('inf', 'inf', use_defaults=False, a=0, b=8, p=107)
point2 = ECPoint(x=2, y=4, use_defaults=False, a=0, b=8, p=107)
point3 = ECPoint(x=-2, y=0, use_defaults=False, a=0, b=8, p=107)
point4= ECPoint(x=2, y=4, use_defaults=False, a=0, b=8, p=97)
